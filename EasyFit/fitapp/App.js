        ...
        options={{
          ...
          tabBarIcon: ({ focused }) => (
            <View>
              <Image
                // tintColor='#2d3436'
                source={require("../EasyFit/assets/home.png")}
                resizeMode="contain"
                style={{
                  width: focused ? 30 : 25,
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ focused }) => (
            <View>
              <Image
                source={require("../EasyFit/assets/gym.png")}
                resizeMode="contain"
                style={{
                  width: focused ? 30 : 25,
                  height: focused ? 30 : 25,
      ...
      <Tab.Screen
        ...
        options={({ route }) => ({
          ...
          tabBarIcon: ({ focused }) => (
            <View>
              <Image
                source={require("../EasyFit/assets/chat.png")}
                resizeMode="contain"
                style={{
                  width: focused ? 30 : 25,
                  height: focused ? 30 : 25,
        ...
        options={({ route }) => ({
          ...
          tabBarIcon: ({ focused }) => (
            <View>
              ...
              <Image
                source={require("../EasyFit/assets/logout.png")}
                resizeMode="contain"
                style={{
                  width: focused ? 30 : 25,
                  height: focused ? 30 : 25,
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ focused }) => (
            <View>
              <Image
                source={require("../EasyFit/assets/user.png")}
                resizeMode="contain"
                style={{
                  width: focused ? 30 : 25,
                  height: focused ? 30 : 25,
